#
#  Be sure to run `pod spec lint AFOAuth1.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors          = { "Song.Wang" => "wangsong44@msn.cn", "other author" => "" }
  # s.author           = 'Song.Wang'
  # s.social_media_url = "http://twitter.com/Song.Wang"
